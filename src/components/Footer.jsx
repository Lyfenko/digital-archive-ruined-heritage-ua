          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left">
            ...
            <div>
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Цифровий архів культурних пам’яток України,<br className="hidden md:block" />
                пошкоджених або знищених внаслідок російської агресії.
              </p>
            ...
            <div className="text-center md:text-right">
              ...
              <p className="text-xs text-white/70">
                © 2025 Зруйнована Спадщина<br />
                Всі права захищено
              </p>
              <p className="text-xs text-white/60 mt-6 italic">
                З любов’ю до України<br />
                та вірою в її відновлення
              </p>
            </div>
          </div>
